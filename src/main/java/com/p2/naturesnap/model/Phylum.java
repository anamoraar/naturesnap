...
@DiscriminatorValue("phylum") //Se diferencia de los otros taxones con este nombre
public class Phylum extends Taxon{
    ...
    public Phylum(String scientific_name, String author, int ancestor, LocalDate publication_year) {
    ...
    public boolean check_ancestor(Optional<Taxon> ancestor) {
        return ancestor.isEmpty() || !(ancestor.get() instanceof Kingdom);
    }
}
